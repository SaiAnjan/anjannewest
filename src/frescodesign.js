    ...
    <article className="mw8 center br2 ba b--red bg-washed-red">
      <div className="dt-ns dt--fixed-ns w-100">
        <div className="pa4 pa4-ns dtc-ns v-mid">
          <div>
            <h2 className="fw3 red mt0 mb3">Please get in touch with me to know more about this project</h2>
            <p className="black-70 measure lh-copy mv0">
              I'm bound to not share the prototypes, but I would love to talk more about my design process, contributions and learnings in this project.
              </p>
          </div>
        </div>
